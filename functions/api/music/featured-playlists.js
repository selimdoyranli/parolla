import { ampFetch, formatArtwork, jsonResponse, localeToStorefront, localeToLang, localeToStrapi } from './_apple.js'
...
export async function onRequestGet(context) {
  ...
  try {
    const res = await fetch(`${strapiBase}/modes/music/featured-playlists?locale=${encodeURIComponent(strapiLocale)}`)
