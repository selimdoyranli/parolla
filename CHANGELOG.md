...
### 📖 Documentation
  ...
  - **specs:** Note tourScore removal from user lookup endpoints ([b43f458](https://github.com/selimdoyranli/parolla/commit/b43f458))
...
### 🩹 Fixes
  ...
  - **tycoon:** Force state wipe for legacy players to prevent economy exploitation ([e6a08ff](https://github.com/selimdoyranli/parolla/commit/e6a08ff))

### 💅 Refactors

  - Update economy of knowledge kingdom ([6f0c7ea](https://github.com/selimdoyranli/parolla/commit/6f0c7ea))
...
### 🩹 Fixes
  ...
  - Ui fixes on choice game scene ([708f758](https://github.com/selimdoyranli/parolla/commit/708f758))
...
### 🩹 Fixes
  ...
  - Ui fixes on question media when active trivia quiz item ([7ad0b03](https://github.com/selimdoyranli/parolla/commit/7ad0b03))
...
[compare changes](https://github.com/selimdoyranli/parolla/compare/v2.36.1...v2.36.2)


### 💅 Refactors

  - Disable move button on compose qa card ([2ed7f95](https://github.com/selimdoyranli/parolla/commit/2ed7f95))
