...
**Draw** is parolla's real-time drawing and guessing game: players take turns drawing a word on a canvas while everyone else races to guess it in the chat. It runs in the browser with no account required.
...
- **Guesser:** 100 base points + a time bonus of up to 200 based on the time left + an order bonus (50 for the first correct guess, 10 less for each one after).
- **Drawer:** up to 200 points, scaled by how many players guessed the word and how quickly. No points if nobody gets it.

## Language

Draw runs on a **Turkish** word list and its interface is Turkish, so the mode is not listed on
the English home page. Play it on the Turkish site at
[www.parolla.app/ciz](https://www.parolla.app/ciz).

## Where to Play

Open Draw at [www.parolla.app/ciz](https://www.parolla.app/ciz). It's free, and you can play as a guest without creating an account.
